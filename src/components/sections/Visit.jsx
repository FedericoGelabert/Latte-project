...
const Visit = () => {
    return (
        <div className="w-screen h-screen relative font-ubuntu flex justify-center items-center lg:mt-0 mt-80" id="visit">
            <div className="flex flex-col justify-center items-center text-white z-30 gap-10 xl:mr-12 2xl:mr-24 mr-0 mt-12">
                ...
                <div className="3xl:w-[40rem] 2xl:w-[32rem] sm:w-[30rem] xs:w-[25rem] w-full 2xl:h-[18rem] lg:h-[15rem] xs:h-[20rem] h-[15rem] flex flex-col items-center">
