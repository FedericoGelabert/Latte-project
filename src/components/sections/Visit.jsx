...
const Visit = () => {
    return (
        <div className="xl:w-screen xl:h-screen relative font-ubuntu flex justify-center items-center lg:pt-0 pt-96 pb-[20rem] lg:pb-6" id="visit">
            <div className="flex flex-col justify-center items-center text-white z-30 gap-10 xl:mr-12 2xl:mr-24 mr-0 mt-12">
                ...
                <div className="3xl:w-[40rem] 2xl:w-[33rem] sm:w-[30rem] xs:w-[25rem] w-full 2xl:h-[17rem] 3xl:h-[19rem] lg:h-[15rem] xs:h-[20rem] h-[15rem] flex flex-col items-center">
            ...
            <div className="lg:h-full h-0 flex items-center">
                <motion.img src="map-location.webp" alt="Map location" className="lg:w-[28rem] 2xl:w-[30rem] w-[0rem] drop-shadow-2xl lg:ml-12"
