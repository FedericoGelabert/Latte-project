...
const Visit = () => {
    return (
        <div className="w-screen h-screen relative font-ubuntu flex justify-center items-center mt-64" id="visit">
            <div className="w-full h-full flex flex-col justify-center items-center text-white z-30 gap-10 xl:mr-12 2xl:mr-24 mr-0 mt-12">
            <div className="bg-[rgba(223,219,182,.9)] mb-24 sm:w-[25rem] xs:w-[20rem] w-[18rem] pr-20 h-[5rem] flex justify-center items-center py-5 rounded-3xl relative">
                    <h2 className="text-gray-700 sm:text-[2.5rem] text-[1.8rem] pl-6">Vist us</h2>
                    <img src="map-location.webp" alt="Map Location" className="absolute xs:w-32 w-[7rem] xs:ml-[20rem] ml-[17rem] -rotate-12" />
                </div>
                <div className="3xl:w-[40rem] 2xl:w-[32rem] sm:w-[30rem] w-11/12 2xl:h-[18rem] lg:h-[15rem] h-[20rem] flex flex-col items-center">
