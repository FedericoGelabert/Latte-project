...
const Visit = () => {
    return (
        <div className="xl:w-screen xl:h-screen relative font-ubuntu flex justify-center" id="visit">
            <div className="h-full flex flex-col justify-center items-center text-white z-30 gap-10 xl:mr-12 2xl:mr-24 mr-0 mt-12">
                <div className="3xl:w-[40rem] 2xl:w-[32rem] w-[30rem] 2xl:h-[18rem] h-[15rem] flex flex-col items-center">
            ...
            <div className="h-full flex items-center">
                <motion.img src="map-location.webp" alt="Map location" className="xl:w-[32rem] 2xl:w-[35rem] w-[25rem] drop-shadow-2xl ml-12"
