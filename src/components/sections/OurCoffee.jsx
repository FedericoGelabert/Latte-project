...
const OurCoffee = () => {
  return (
    <div className="xl:w-screen xl:h-screen relative font-ubuntu flex items-center justify-center" id="coffee">
      <div className="h-full flex items-center justify-center flex-col text-white z-30">
        <div className="px-16 pb-12 bg-[rgba(10,57,52,.89)] w-10/12 3xl:w-[70rem] h-[24rem] rounded-3xl relative shadow-xl shadow-black">
      ...
      <img src="coffee2.webp" alt="Coffee" className="xl:w-[20rem] 2xl:w-[20rem] 3xl:w-[26rem] w-0 z-40 rotate-6 xl:mr-32 xl:ml-20 ml-0 mr-0" />
    </div>
  )
}
