  ...
  return (
    <div className="w-screen h-screen relative font-ubuntu flex items-center justify-center" id="coffee">
      <div className="h-full flex items-center justify-center flex-col text-white z-30">
        <div className="px-16 pb-12 bg-[rgba(10,57,52,.89)] w-[70rem] h-[24rem] rounded-3xl relative shadow-xl shadow-black">
      ...
      <img src="coffee2.webp" alt="Coffee" className="w-83 z-40 rotate-6 ml-24" />
    </div>
  )
}
