      ...
      <div className="w-full h-full flex items-center justify-center flex-col text-white z-30">
        <div className="px-16 pb-12 bg-[rgba(10,57,52,.89)] w-10/12 h-[40%] rounded-3xl relative shadow-xl shadow-black">
          ...
          <div className="flex gap-10 justify-center">
            <div>
              <div className="w-48 h-48 bg-[rgba(223,219,182,.9)] rounded-3xl flex items-center flex-col justify-center gap-5 text-black shadow-xl shadow-black">
                <img src="milk.webp" alt="Milk" className="w-24" />
              </div>
            </div>
            <div className="w-48 h-48 bg-[rgba(223,219,182,.9)] rounded-3xl flex items-center flex-col justify-center gap-5 text-black shadow-xl shadow-black">
              <img src="coffee-machine2.webp" alt="Badge" className="w-24" />
            </div>
            <div className="w-48 h-48 bg-[rgba(223,219,182,.9)] rounded-3xl flex items-center flex-col justify-center gap-5 text-black shadow-xl shadow-black">
              <img src="coffee-bag2.webp" alt="Badge" className="w-[7rem]" />
            </div>
          </div>
        </div>
      </div>
