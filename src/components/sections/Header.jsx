    ...
    return (
        <div className="flex w-full justify-center h-[5rem] z-50 fixed pt-6" id="header">
            ...
            <div className="container flex justify-center items-center text-white">
                <img src="logo-green.webp" alt="Logo" className="w-[4.5rem] absolute left-0 ml-[4.5rem]" />
                ...
                <div onClick={audioFunction} className="flex h-full items-center">
                    {
                        audioStatus ?
                            ...
                            <svg id="audioMuted" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="show w-8 h-8 absolute right-0 mr-[7rem]">
