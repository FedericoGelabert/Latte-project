...
const Story = () => {
    ...
    return (
        <div className="xl:w-screen xl:h-screen relative font-ubuntu flex items-center justify-center pt-48 xl:pt-0 lg:pb-0 pb-[10rem]" id="story">
            <div className="w-full h-full flex items-center justify-center text-white z-30 relative">
                <div className="h-full flex items-center justify-center relative">
                    ...
                    />
                        <div className="w-11/12 xl:w-[65rem] md:h-[32rem] md:py-0 py-3 bg-[rgba(10,57,52,.89)] flex justify-center items-center rounded-3xl relative ml-0 xl:ml-32">
                            <div className="w-12/12 mx-5 xl:w-[63rem] 3xl:mr-4 md:h-[30rem] md:py-0 py-12 bg-[rgba(223,219,182,.9)] rounded-3xl relative sm:px-12 px-6 xl:pl-[22rem] xl:px-0 xl:pr-12 md:pr-24 sm:pr-12 ">
