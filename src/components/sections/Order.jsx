...
const Order = () => {
  ...
  const goOrderForm = () => {
    const divOrderForm = document.getElementById('orderForm')
    const divOrderMain = document.getElementById('orderMain')

    if (orderForm == false) {
      divOrderForm.classList.add('show')
      divOrderForm.classList.remove('hide')
      divOrderMain.classList.add('hide')
      divOrderMain.classList.remove('show')
  ...
  return (
    <div className="w-screen h-screen relative font-ubuntu flex flex-col items-center justify-center" id="order">
      ...
      <div className="hide" id="orderForm">
        <OrderForm />
      </div>
    </div>
  )
