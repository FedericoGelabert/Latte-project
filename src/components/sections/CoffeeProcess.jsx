...
const CoffeeProcess = () => {
  return (
    <div className="w-screen h-screen relative font-ubuntu flex items-center justify-center" id="coffee">
      <img src="coffee-package.webp" alt="Coffee Package" className="z-40 w-[30rem] rotate-6 mr-24"/>
      <div className="flex items-center justify-center flex-col text-white z-30">
        <div className="px-16 pb-12 bg-[rgba(10,57,52,.89)] w-[70rem] h-3/6 rounded-3xl relative shadow-xl shadow-black">
