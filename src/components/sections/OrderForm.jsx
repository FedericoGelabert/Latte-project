                            ...
                            <div className="lg:px-16 sm:px-8 px-4 mt-12 bg-[rgba(10,57,52,.89)] lg:w-[60rem] w-11/12 pb-12 rounded-3xl relative shadow-xl shadow-black">
                                <form ref={form}>
                                    ...
                                    <div className="w-full flex lg:flex-row flex-col lg:items-start items-center justify-around gap-5 mb-5">
                                        <input type="text" placeholder="Name" required className="w-10/12 lg:w-[20rem] p-3 bg-inherit border-b-2 focus:bg-[#f3f3ed] focus:text-black" name="name" id="user_name" value={name} onChange={e => setName(e.target.value)} />
                                        <input type="text" placeholder="Surname" required className="w-10/12 lg:w-[20rem] p-3 bg-inherit border-b-2 focus:bg-[#f3f3ed] focus:text-black" name="user_surname" id="user_surname" value={surname} onChange={e => setSurname(e.target.value)} />
                                    </div>
                                    <div className="w-full flex lg:flex-row flex-col lg:items-start items-center justify-around lg:mt-6 mt-0 gap-5">
                                        <input type="email" placeholder="Email" required className="w-10/12 lg:w-[20rem] p-3 bg-inherit border-b-2 focus:bg-[#f3f3ed] focus:text-black" name="user_email" value={email} id="user_email" onChange={e => setEmail(e.target.value)} />
                                        <input type="text" placeholder="Phone Numer" required className="w-10/12 lg:w-[20rem] p-3 bg-inherit border-b-2 focus:bg-[#f3f3ed] focus:text-black" name="user_phonenumber" value={phonenumber} id="user_phonenumber" onChange={e => setPhonenumber(e.target.value)} />
                                    </div>
                                    <div className="w-full flex sm:flex-row flex-col mt-6 items-center md:h-12 xs:h-32 h-40 sm:pl-0 pl-12">
                                        ...
                                        <div className="sm:w-[20rem] w-full h-[3rem]">
                                            {
                                                latteId ?
                                                    <input type="password" placeholder="Latte ID" className="p-3 bg-inherit border-b-2 sm:mt-0 mt-5 sm:w-[10rem] w-10/12 focus:bg-[#f3f3ed] focus:text-black" maxLength={6} id="latteIdInput" name="user_latteid" value={latteid} onChange={e => setLatteid(e.target.value)} />
                                                    :
                                                    ""
                                            }
                                        </div>
                                    ...
                                    <div className="w-full h-[9.8rem] flex rounded-t-lg border-2 border-white overflow-auto overflow-y-hidden">
                                        <div className="flex">
                                            {itemsSelected.map((itemSelected, index) => {
                                                return (
                                                    <div className="bg-[rgba(223,219,182,.9)] min-w-[8rem] h-[7.6rem] m-2 rounded-2xl text-black p-2 flex flex-col items-center justify-center relative" key={index} name="order_details">
                                    ...
                                    <div className="w-full flex justify-center items-center mt-2 flex-col text-center cursor-pointer">
                                        ...
                                        <input type="submit" value="Send" className="lg:w-6/12 sm:w-8/12 w-10/12 text-white font-bold px-12 py-3 mt-3 border-2 rounded-3xl hover:bg-[rgba(10,57,52,1)] hover:scale-105 hover:duration-300 transition-all" onClick={goOrderEmail} />
                                    </div>
                                </form>
                            </div>
                        </div>
