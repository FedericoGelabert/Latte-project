    ...
    return (
            <div className="w-screen h-screen relative font-ubuntu flex justify-center items-center" id="home">
                <div className="text-white absolute z-30 flex items-center">
                    <motion.img transition={{ duration: 1 }} whileInView="visible" viewport={{ once: true }} variants={latteLogoTransition} initial="hidden" src="logo-green.png" alt="Logo" className="w-96 z-40" />
