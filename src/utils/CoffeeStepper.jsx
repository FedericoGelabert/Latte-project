    ...
    return (
        <div className="w-full xs:px-12 px-6 py-12">
            <div className="relative flex lg:flex-row flex-col items-center justify-between w-full gap-10">
                ...
                <div className="absolute top-2/4 h-[98%] w-[0.1rem] lg:w-[0] -translate-y-2/4 bg-gray-300 lg:hidden show"></div>
                ...
                <motion.div
                    ...
                    <div className="absolute lg:-bottom-[4.5rem] -bottom-4 lg:mr-0 mr-[9rem] w-max lg:text-center text-right">
                        <h6
                ...
                <motion.div
                    ...
                    <div className="absolute lg:-bottom-[4.5rem] -bottom-4 lg:ml-0 ml-[9rem] w-max lg:text-center text-left">
                        <h6
                            className="block font-sans text-base antialiased font-semibold leading-relaxed tracking-normal text-white">
                            Step 2
                        </h6>
                ...
                <motion.div
                    ...
                    <div className="absolute lg:-bottom-[4.5rem] lg:ml-0 sm:ml-[13rem] ml-[8.8rem] -bottom-4 w-max lg:text-center text-left">
                        <h6
                            className="block font-sans text-base antialiased font-semibold leading-relaxed tracking-normal text-white">
                            Step 4
                        </h6>
                ...
                <motion.div
                    ...
                    <div className="absolute lg:-bottom-[4.5rem] -bottom-4 ml-[11.5rem] lg:ml-0 w-max lg:text-center text-left">
                        <h6
                            className="block font-sans text-base antialiased font-semibold leading-relaxed tracking-normal text-white">
                            Step 6
                        </h6>
